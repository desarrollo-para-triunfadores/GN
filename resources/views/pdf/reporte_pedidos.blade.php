...
<head>
    ...
    <style type="text/css" rel="stylesheet" href="{{ asset('plantillas/css/pdf.css') }}"></style>
</head>
    ...
    <div class="container">
        ...
        <div class="company-contact">
            ...
            <div class="email right">
                ...
                <a href="mailto:company@example.com">info@.gnsoluciones.com</a>
                <span class="helper"></span>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <th class="unit">Fecha Pedido</th>
                <th class="total">Importe</th>
                <th class="total">Cantidad Señada</th>
                <th class="total">Tomó</th>
                <th class="total">Modalidad Pago</th>
                <th class="total">Entrega</th>
            </tr>
            </thead>
            <tbody>
            {{--
            ...
            @foreach($pedidos_reporte as $pedido)
                <tr>
                    <td class="text-center">#</td>
                    <td class="text-center text-facebook text">{{ $pedido['cliente'] }}</td>
                    <td class="text-center">{{ $pedido['fecha'] }}</td>
                    <td class="text-center">${{ $pedido['importe']}}</td>

                    <td class="text-center">{{ $pedido['sena'] }}</td>

                    <td class="text-center">{{ $pedido['tomo']}}</td>
